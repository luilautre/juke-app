...
// Middleware pour fichiers statiques et cookies
app.use(express.static(path.join(__dirname, 'public')));
app.use(cookieParser());
app.use(express.urlencoded({ extended: true }));

// Middleware Speed Insights
...
// Stockage en mémoire (remplacer par une DB pour prod)
const cafes = {};
...
app.listen(port, () => console.log(`Juke-app server running on http://localhost:${port}`));
